...
# prepare variable --------------------------------------------------------
seq_pan_stats_file <- here("comb", "all_stats.txt")
...
n_p <- ggplot() +
  ...
  scale_color_manual(name = "", labels = c("Pan-genome", "Core genome", "Dispensable genome", "Private genome"), values=c("#E7298A", "#66A61E", "#E6AB02", "#7570B3")) +
...
ggsave(n_p, filename = here("plots", "sequence_pangenome_modeling_n.pdf"), width = 3.5, height = 3)

save(n_p, file = here("plots", "sequence_pangenome_modeling_n.rda"))
...
ggsave(len_p, filename = here("plots", "sequence_pangenome_modeling_len.pdf"), width = 3.5, height = 2.5)

save(len_p, file = here("plots", "sequence_pangenome_modeling_len.rda"))
...
ggsave(p, filename = here("plots", "sequence_pangenome_modeling.pdf"), width = 7, height = 3)
