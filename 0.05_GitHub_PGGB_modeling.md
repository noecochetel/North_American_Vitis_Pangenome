...
## gene modeling
For the gene modeling, genes will be classed as core, disp or priv based on the nodes composing them. For example, a gene composed with > 80% of core nodes will be considered a core gene.
